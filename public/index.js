...
if (!bearer) updateLoadingHTML('<a href="https://discordapp.com/api/oauth2/authorize?client_id=583910433300152331&redirect_uri=http%3A%2F%2Fqueue-manager.glitch.me&response_type=code&scope=identify"><button type="button" class="btn btn-dark">Login With Discord</button></a>')
